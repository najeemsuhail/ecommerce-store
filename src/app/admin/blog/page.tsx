      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link
              href="/admin/blog/new"
              className="btn-block-primary-md w-full sm:w-auto text-center"
            >
              + New Blog
            </Link>
          </div>
                ...
                <div key={blog.id} className="p-4 space-y-3">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 flex-1">
                      <p className="font-semibold text-gray-900 break-words">{blog.title}</p>
                      <p className="text-xs text-gray-500 break-all mt-1">{blog.slug}</p>
                    </div>
                    <span
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div>
                      ...
                      <p className="text-gray-700 break-words">{blog.author || '-'}</p>
                    </div>
                    <div>
                      <p className="text-xs uppercase tracking-wide text-gray-500">Date</p>
                      <p className="text-gray-700">{new Date(blog.createdAt).toLocaleDateString()}</p>
                    </div>
                  </div>
