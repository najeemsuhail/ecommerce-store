...
const heroSlides: HeroSlide[] = [
  {
    ...
    secondaryCTA: { label: 'Browse Categories', href: '/collections/home-essentials' },
  ...
  },
  {
    ...
    primaryCTA: { label: 'Explore Kitchen', href: '/collections/kitchen' },
    secondaryCTA: { label: 'View Storage Items', href: '/collections/storage' },
